...
from model.DeepSORT.detector.YOLOv5.models.common import DetectMultiBackend
from model.DeepSORT.detector.YOLOv5.utils.augmentations import letterbox
from model.DeepSORT.detector.YOLOv5.utils.datasets import IMG_FORMATS, VID_FORMATS, LoadImages, LoadStreams
from model.DeepSORT.detector.YOLOv5.utils.general import (LOGGER, check_file, check_img_size, check_imshow, check_requirements, colorstr,
                           increment_path, non_max_suppression, print_args, scale_coords, strip_optimizer, xyxy2xywh)
from model.DeepSORT.detector.YOLOv5.utils.plots import Annotator, colors, save_one_box
from model.DeepSORT.detector.YOLOv5.utils.torch_utils import select_device, time_sync
